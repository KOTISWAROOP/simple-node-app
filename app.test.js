...
describe('GET /', () => {
  ...
  it('should respond with a 200 status code and "Hello World!!! welcome TO CI/CD PIPELINE."', async () => {
    ...
    expect(response.text).toBe('Hello World!!! welcome TO CI/CD PIPELINE.');
  });
